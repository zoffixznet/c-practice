 ...
 *
 *  It contains minor modifications, to match output expected by MoarVM/Perl 6.
 *
 ...
 *
 *  Grisu3 is able to handle about 95% of numbers, for the remaining 5%
 *  the code below fallsback to sprintf(). It's possible that using a
...
int dtoa_grisu3(double v, char *dst) {
        ...
        // Prehandle NaNs
        if ((u64 << 1) > 0xFFE0000000000000ULL) return sprintf(dst, "NaN");
...
int main (void) {
    char buf[64], *res[] = {
        ...
        "6.0221409e+23", "6.0221408999999994e+23", "123.456789",
        "0.21994751806560198", "5e-324", "8.737675311215749e+198",
        "-7.7153816322343865e+28", "3.3158061496377107e-21"
    };
    double sou[] = {
        ...
        6.0221409e+23,  60221408999999994e7, 123.456789,
        0.21994751806560198, 5e-324, 8.737675311215749e+198,
        -7.7153816322343865e+28, 3.3158061496377107e-21
    };
